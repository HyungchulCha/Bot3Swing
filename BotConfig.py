...
FILE_URL_BLNC_3M = FILE_URL + '/BalanceList_3m.pickle'
FILE_URL_SMBL_3M = FILE_URL + '/SymbolList_3m.pickle'
FILE_URL_BACK = DIRECTORY + '/BacktestResult'
FILE_URL_BLNC_TEST_3M = FILE_URL_BACK + '/BalanceListTest_3m.pickle'